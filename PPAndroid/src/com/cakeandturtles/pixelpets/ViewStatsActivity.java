...
public class ViewStatsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (extras != null){
			Boolean fromGarden = extras.getBoolean("com.cakeandturtles.pixelpets.fromGarden");
			Boolean fromTraining = extras.getBoolean("com.cakeandturtles.pixelpets.fromTraining");
			Boolean fromAdventure = extras.getBoolean("com.cakeandturtles.pixelpets.fromAdventure");
			if (fromGarden != null && fromGarden){
				((Button)findViewById(R.id.back_to_menu)).setText("Back to Garden");
			}else if (fromTraining != null && fromTraining){
				((Button)findViewById(R.id.back_to_menu)).setText("Back to Battle");
			}else if (fromAdventure != null && fromAdventure){
				((Button)findViewById(R.id.back_to_menu)).setText("Back to Adventure");
			}
		}
